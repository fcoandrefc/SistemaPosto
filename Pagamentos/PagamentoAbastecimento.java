...
public class PagamentoAbastecimento {
	...
	public void PagamentoFinal(int OpcaoAbastecer, double ValorCombustivel){
		...
		do {
			...
			System.out.println("Digita Valor do abastecer :");
		...
		do {
		  ...
		  switch (OpcaoPagamento) {
			...
			case 1:
				...
				System.out.printf("| Valor Dinheiro: %2.2f  | Valor Abastecido: %2.2f | Valor Combustivel: %2.2f"  + 
				"| Total Litros: %2.2f | Troco: %2.2f ",ValorNota,ValorPagamento,ValorCombustivel,TotalLitros, (ValorNota - ValorPagamento));
